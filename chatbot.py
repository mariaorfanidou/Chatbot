...
keywords = {
   ...
   # "μωρό": ["μωρό", "νεογένητο", "πρώτο", "εβδομάδες", "γατάκι", "μηνών", "βρήκα", "υιοθεσία"],
    ...
    "εμβόλια": ["εμβόλια", "ετήσιο", "εμβόλιο", "πότε", "λύσσα", "βασικά", "γρίπη", "πανλευκοπενία", "λευχαιμία", "υποχρεωτικό"],
    "παράσιτα": ["παράσιτα", "μόλυνση", "δερματικό", "φαγούρα", "αποπαρασίτωση", "τσιμπούρι", "ψύλλοι", "σκουλήκια", "τριχοπτωση", "πέφτουν", "κενα τριχών", "αποπαρασιτωσεις", "παράσιτα γάτας"],
    "υιοθεσία": ["υιοθεσία", "βρήκα", "καταφύγιο", "διάσωση", "υιοθετώ", "υιοθετώ γάτα", "υιοθεσία γάτας", "γατάκι", "σπίτι"],
    "κτηνίατρος" :[ "κτηνίατρος", "επίσκεψη", "υγειονομική περίθαλψη", "εξέταση", "διατροφή", "ευημερία", "υγεία", "συμβουλές", "βιβλιαριο", "εμβολιασμός", "προληπτική φροντίδα", "γιατρος", "κτηνίατρος"],
